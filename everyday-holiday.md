...
> **Live my off-hours like I'm on holiday — present, unhurried, and delighted by my own life.**

The trip was never the point — the *mindset* was. On holiday you slow down, notice everything, say yes, and treat ordinary moments as special. None of that needs a plane ticket. This is the same 9-grid as the energy sprint, pointed at joy.

**The one rule: romance the ordinary.** Pick 1–2 of these a day. That's it.

---

## The Center 3×3 (goal + 8 ways of being on holiday)

| | | |
|---|---|---|
| 🌅 **Slow Time** | 🗺️ **Play Tourist** | 🕯️ **Set the Scene** |
| ☕ **Little Luxuries** | 🌴 **EVERYDAY HOLIDAY** | 🌿 **Be Here Now** |
| 🛋️ **Rest, No Guilt** | 🎈 **Say Yes** | 💃 **Main Character** |

---

## 1. 🌅 Slow Time
- [ ] Wake 20 min early for a slow, screen-free start
- [ ] Drink your coffee/tea somewhere beautiful — no scrolling
- [ ] Leave one evening with nowhere to be
...
- [ ] Fresh flowers on the table each week
- [ ] Make a "holiday" playlist and put it on
- [ ] Warm lamps instead of the harsh overhead light
- [ ] Reset one space so it feels like a hotel room
- [ ] Open the windows — let in light and air
- [ ] Use the nice glass / good plates for a normal meal
- [ ] Keep a scent or fresh linen you genuinely love

## 4. 🌿 Be Here Now
- [ ] Phone in another room for the first hour home
- [ ] One meal a day eaten slowly, no screen
- [ ] Notice three beautiful things each day
- [ ] Take one photo of something ordinary-but-lovely
- [ ] Sit and just watch/listen for five minutes
- [ ] Feel one sensation fully — sun, water, breeze
- [ ] Name what you're grateful for right now
- [ ] Drop the productivity — this hour is just to be

## 5. 💃 Main Character
- [ ] Dress nicely even when you're staying in
- [ ] Wear the outfit/perfume you "save for special"
...
- [ ] Move slowly for a whole afternoon
